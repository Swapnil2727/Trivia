...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //bind to game data variable
        binding.game = this

        binding.submitButton.setOnClickListener(View.OnClickListener { View ->
            ...
            if (-1 != checkedId) {
                ...
                var answerIndex = 0
                when (checkedId) {
                    R.id.option2_radiobutton -> answerIndex = 1
                    R.id.option3_radiobutton -> answerIndex = 2
                    R.id.option4_radiobutton -> answerIndex = 3
